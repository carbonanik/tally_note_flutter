...
import 'package:tally_note_flutter/views/auth/sign_up/sign_up_otp_page.dart';
...
class SignUpPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ref.listen(
      ...
      (_, state) {
        if (state.result == CreateAccountResult.verificationCodeSent) {
        ...
        } else if (state.result == CreateAccountResult.accountExists) {
                ...
                FilledButton(
                  onPressed: () async {
                    ...
                    ref
                        ...
                        .storeEmailPassword(_phoneNumberWithCountryCode(), passwordController.text);
                    await ref
                        .read(createAccountProvider.notifier)
                        .createUser(_phoneNumberWithCountryCode());
                  },
                  child: const Padding(
